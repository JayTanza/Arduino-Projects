...
void initAll()
{
  ...
  module_2.init(PIN_TYPE_BTN_2, PIN_TYPE_SERVO_3, PIN_TYPE_LED_2, PIN_TYPE_SENSOR_1, 2, 10);
  module_3.init(PIN_TYPE_BTN_3, PIN_TYPE_SERVO_2, PIN_TYPE_LED_3, PIN_TYPE_SENSOR_1, 3, 20);
  module_4.init(PIN_TYPE_BTN_3, PIN_TYPE_SERVO_2, PIN_TYPE_LED_4, PIN_TYPE_SENSOR_1, 4, 20);
}
