...
void initAll(){
  ...
  module_2.init(PIN_TYPE_BTN_4,PIN_TYPE_SERVO_1,PIN_TYPE_IR_2,PIN_TYPE_BUZZER_1, 1, 5);  
  module_3.init(PIN_TYPE_BTN_4,PIN_TYPE_SERVO_2,PIN_TYPE_IR_3,PIN_TYPE_BUZZER_1, 2, 1);  
