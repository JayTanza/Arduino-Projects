...
#define PIN_TYPE_IR_2 8
#define PIN_TYPE_IR_3 11
...
void initAll(){
  ...
  module_2.init(PIN_TYPE_BTN_4,PIN_TYPE_SERVO_1,PIN_TYPE_IR_2,PIN_TYPE_BUZZER_1, 1, 1);  
  module_3.init(PIN_TYPE_BTN_4,PIN_TYPE_SERVO_2,PIN_TYPE_IR_3,PIN_TYPE_BUZZER_1, 2, 5);  
